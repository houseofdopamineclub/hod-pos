...
// HOD's NEW window (per Khushi 11 May 2026): club operates from 12 NOON IST
// through 12 NOON next day. Anything BEFORE 12 NOON IST counts as the PREVIOUS
// operational day (e.g. Sun 11am IST is still "Saturday's" night). At 12pm IST
// sharp the dashboard rolls over to the new day's data.
// PREVIOUSLY: 6am→6am cutoff (shift -6h). Changed to 12pm→12pm (shift -12h).
...
// the next day's noon rollover). 12:00 IST = 06:30 UTC same calendar day.
