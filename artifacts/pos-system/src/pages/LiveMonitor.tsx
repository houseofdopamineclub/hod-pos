...
function startOfTonightMs(): number {
  // Operational night starts 6pm local; for "today's events" use 6am cutoff.
  const d = new Date(); d.setHours(12, 0, 0, 0); // 12pm IST cutoff (matches getOperationalNightStr)
