...
// 🆕 v3.105 — `embedded` hides the "← Back" link when AuditPage renders as
// a tab inside AdminPage (Boss Mode). Standalone /audit route keeps the back
// link for direct deep-link visitors.
